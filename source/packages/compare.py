def compare(ED_Results_path, PVed, PVactual, BESSstatus, Load_data, pd, sim_time, Load_shape, deepcopy):
    col_name = []
    for i in range(0, 24):
    ...
    tempgen1 = df_ed.loc[df_ed[df_ed.columns[0]] == 'G1']
    tempgen2 = df_ed.loc[df_ed[df_ed.columns[0]] == 'G2']
    tempgen3 = df_ed.loc[df_ed[df_ed.columns[0]] == 'G3']
    list3_g1 = tempgen1.iloc[0][9:].tolist()
    list6_g2 = tempgen2.iloc[0][9:].tolist()
    list7_g3 = tempgen3.iloc[0][9:].tolist()
    bess_dict = {}
